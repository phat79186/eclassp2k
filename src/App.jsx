...
// Logo S-Class P2K 
const LOGO_SM = "/logo.jpg"; // 72×72 — dùng ở sidebar
const LOGO_LG = "/logo.jpg"; // 120×120 — dùng ở login + loading
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 420, padding: "0 20px", animation: "fadeUp .4s ease" }}>
        <div style={{ textAlign: "center", marginBottom: 30 }}>
          ...
          <div style={{ marginBottom: 16, animation: "float 4s ease-in-out infinite", display: "inline-block" }}>
            <img src={LOGO_LG} alt="S-Class P2K" style={{ width: 96, height: 96, borderRadius: 22, boxShadow: "0 12px 36px rgba(29,108,245,.45)", display: "block" }} />
          </div>
          <h1 className="hfont" style={{ fontSize: 32, fontWeight: 400, letterSpacing: "-.01em", color: "var(--text)" }}>
            S-Class <span style={{ color: "var(--accent)" }}>P2K</span>
          </h1>
  ...
  return (
    <div className={`sidebar-wrapper ${col ? "col" : ""}`}>
      <div style={{ height: 60, display: "flex", alignItems: "center", padding: col ? "0 11px" : "0 16px", borderBottom: "1px solid var(--border2)", gap: 11, flexShrink: 0 }}>
        <img src={LOGO_SM} alt="S-Class P2K" style={{ width: 36, height: 36, borderRadius: 11, flexShrink: 0, boxShadow: "0 4px 16px rgba(29,108,245,.4)", display: "block", objectFit: "cover" }} />
        {!col && <span className="hfont" style={{ fontSize: 15, fontWeight: 400, whiteSpace: "nowrap", color: "var(--text)" }}>S-Class <span style={{ color: "var(--accent)" }}>P2K</span></span>}
      </div>
      {!col && (
...
function SettingsPage({ state, user, setUser }) {
  ...
  const exportData = () => {
    ...
    a.href = uri;
    a.download = "sclassp2k-backup.json";
...
export default function SClassP2K() {
    ...
    return (
      <>
        ...
        <div className={`ecp${darkMode ? '' : ' light'}`} style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ textAlign: "center" }}>
            <img src={LOGO_LG} alt="S-Class P2K" style={{ width: 72, height: 72, borderRadius: 20, boxShadow: "0 12px 36px rgba(29,108,245,.45)", marginBottom: 20, animation: "float 2s ease-in-out infinite", display: "inline-block" }} />
